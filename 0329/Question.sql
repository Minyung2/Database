...
SELECT * FROM JOB_HISTORY jh LEFT JOIN EMPLOYEES e ON E.EMPLOYEE_ID =JH.EMPLOYEE_ID 
...
SELECT E.* FROM EMPLOYEES e, JOB_HISTORY jh WHERE JH.EMPLOYEE_ID = E.EMPLOYEE_ID  ON NOT EXISTS(SELECT JH.END_DATE );
